// UndoItemTab2Space.h: CUndoItemTab2Space クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UNDOITEMTAB2SPACE_H)		//２重インクルード防止
#define UNDOITEMTAB2SPACE_H
...
class CUndoItemTab2Space : public CUndoItem
{
public:
	CUndoItemTab2Space();									// コンストラクタ
	CUndoItemTab2Space(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemTab2Space();							// デストラクタ
...
#endif // !defined(UNDOITEMTAB2SPACE_H)
