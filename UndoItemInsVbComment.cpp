// UndoItemInsVbComment.cpp: CUndoItemInsVbComment クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemInsVbComment::CUndoItemInsVbComment()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
	...
	)
{
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			pobjLine->InsertChar(lSelectStartOffset,CODE_SQUOTE,0);
	...
	else //複数行選択
	{
		for(ULONG lCnt=0; lCnt<(ULONG)(lSelectEndLine-lSelectStartLine+1); lCnt++ )
		{
			...
			if( pobjLine != NULL )
			{
				...
				{
					pobjLine->InsertChar(0,CODE_SQUOTE,0);
				}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsVbComment::doUndo()
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsVbComment::doRedo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
	...
	if( m_lSelectStartLine == m_lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			pobjLine->InsertChar(m_lSelectStartOffset,CODE_SQUOTE,0);
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemInsVbComment::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemInsVbComment::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsVbComment::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsVbComment::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
