// UndoItemTabWhenSelected.h: CUndoItemTabWhenSelected クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UNDOITEMTABWHENSELECTED_H)		//２重インクルード防止
#define UNDOITEMTABWHENSELECTED_H
...
class CUndoItemTabWhenSelected : public CUndoItem
{
public:
	CUndoItemTabWhenSelected();								// コンストラクタ
	CUndoItemTabWhenSelected(CEditorDoc*);					// コンストラクタ
	virtual ~CUndoItemTabWhenSelected();					// デストラクタ
...
#endif // !defined(UNDOITEMTABWHENSELECTED_H)
