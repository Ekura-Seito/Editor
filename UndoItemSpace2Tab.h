// UndoItemSpace2Tab.h: CUndoItemSpace2Tab クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemSpace2Tab_H)		//２重インクルード防止
#define UndoItemSpace2Tab_H
...
class CUndoItemSpace2Tab : public CUndoItem
{
public:
	CUndoItemSpace2Tab();									// コンストラクタ
	CUndoItemSpace2Tab(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemSpace2Tab();							// デストラクタ
...
#endif // !defined(UndoItemSpace2Tab_H)
