// UndoItemAlnumZen2Han.h: CUndoItemAlnumZen2Han クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemAlnumZen2Han_H)		//２重インクルード防止
#define UndoItemAlnumZen2Han_H
...
class CUndoItemAlnumZen2Han : public CUndoItem
{
public:
	CUndoItemAlnumZen2Han();								// コンストラクタ
	CUndoItemAlnumZen2Han(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemAlnumZen2Han();						// デストラクタ
...
#endif // !defined(UndoItemAlnumZen2Han_H)
