// UndoItemAl2Lower.h: CUndoItemAl2Lower クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemAl2Lower_H)		//２重インクルード防止
...
{
public:
	CUndoItemAl2Lower();									// コンストラクタ
	CUndoItemAl2Lower(CEditorDoc*);							// コンストラクタ
	virtual ~CUndoItemAl2Lower();							// デストラクタ
