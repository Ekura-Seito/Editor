// UndoItemDelVbComment.cpp: CUndoItemDelVbComment クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemDelVbComment::CUndoItemDelVbComment()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
	...
	)
{
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			...
			if( !IsDBCSLeadByteEx(0,c1stChar) && c1stChar == CODE_SQUOTE )
			{
				//シングルクオートのＶＢコメント削除
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemDelVbComment::doUndo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemDelVbComment::doRedo()
{
	unsigned char c1stChar=0;				//DELETEされた第一バイト文字
	unsigned char c2ndChar=0;				//DELETEされた第二バイト文字
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemDelVbComment::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemDelVbComment::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemDelVbComment::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemDelVbComment::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
