// UndoItemInsCppComment.cpp: CUndoItemInsCppComment クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemInsCppComment::CUndoItemInsCppComment()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsCppComment::Do()
{
}
	...
	)
{
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		{
			//ダブルスラッシュのＣ＋＋コメント挿入
			pobjLine->InsertChar(lSelectStartOffset,'/',0);
			pobjLine->InsertChar(lSelectStartOffset,'/',0);
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsCppComment::doUndo()
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsCppComment::doRedo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
	...
	if( m_lSelectStartLine == m_lSelectEndLine ) //１行選択
	{
		...
		{
			//ダブルスラッシュ挿入
			pobjLine->InsertChar(m_lSelectStartOffset,'/',0);
			pobjLine->InsertChar(m_lSelectStartOffset,'/',0);
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemInsCppComment::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemInsCppComment::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsCppComment::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemInsCppComment::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
