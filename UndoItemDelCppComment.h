// UndoItemDelCppComment.h: CUndoItemDelCppComment クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemDelCppComment_H)		//２重インクルード防止
...
{
public:
	CUndoItemDelCppComment();								// コンストラクタ
	CUndoItemDelCppComment(CEditorDoc*);					// コンストラクタ
	virtual ~CUndoItemDelCppComment();						// デストラクタ
...
private:
	...
	//操作情報
	long		m_lStartLine;								// ＣＰＰコメント削除処理後の開始位置の行番号
	long		m_lStartOffset;								// ＣＰＰコメント削除処理後の開始位置の列番号
	long		m_lEndLine;									// ＣＰＰコメント削除処理後の終了位置の行番号
	long		m_lEndOffset;								// ＣＰＰコメント削除処理後の終了位置の列番号
