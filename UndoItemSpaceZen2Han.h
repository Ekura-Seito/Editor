// UndoItemSpaceZen2Han.h: CUndoItemSpaceZen2Han クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemSpaceZen2Han_H)		//２重インクルード防止
#define UndoItemSpaceZen2Han_H
...
class CUndoItemSpaceZen2Han : public CUndoItem
{
public:
	CUndoItemSpaceZen2Han();								// コンストラクタ
	CUndoItemSpaceZen2Han(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemSpaceZen2Han();						// デストラクタ
...
#endif // !defined(UndoItemSpaceZen2Han_H)
