// WordCountDlg.cpp : インプリメンテーション ファイル
//
	...
	: CDialog(CWordCountDlg::IDD, pParent)
{
	...
	m_objFolder = _T("");					// ワードカウント実行フォルダ
	m_objFileKind = _T("");					// カウント対象のファイル種別
