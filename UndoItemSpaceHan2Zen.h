// UndoItemSpaceHan2Zen.h: CUndoItemSpaceHan2Zen クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemSpaceHan2Zen_H)		//２重インクルード防止
#define UndoItemSpaceHan2Zen_H
...
class CUndoItemSpaceHan2Zen : public CUndoItem
{
public:
	CUndoItemSpaceHan2Zen();								// コンストラクタ
	CUndoItemSpaceHan2Zen(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemSpaceHan2Zen();						// デストラクタ
...
#endif // !defined(UndoItemSpaceHan2Zen_H)
