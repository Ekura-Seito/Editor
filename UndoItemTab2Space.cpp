// UndoItemTab2Space.cpp: CUndoItemTab2Space クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemTab2Space::CUndoItemTab2Space()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			...
			for(long nCnt=lSelectStartOffset; nCnt<lEndOffsetAfter; )
			{
				...
				if(pobjLine->GetAt(nCnt) != '\t')//タブコード以外
				{
					nCnt++;
					nOffset += lfWidth;
					continue;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTab2Space::doUndo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTab2Space::doRedo()
{
	long lEndOffsetAfter=0;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemTab2Space::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemTab2Space::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTab2Space::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTab2Space::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
