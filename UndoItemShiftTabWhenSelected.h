// UndoItemShiftTabWhenSelected.h: CUndoItemShiftTabWhenSelected クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemShiftTabWhenSelected_H)		//２重インクルード防止
...
{
public:
	CUndoItemShiftTabWhenSelected();						// コンストラクタ
	CUndoItemShiftTabWhenSelected(CEditorDoc*);				// コンストラクタ
	virtual ~CUndoItemShiftTabWhenSelected();				// デストラクタ
