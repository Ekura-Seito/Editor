// UndoItemShiftTabWhenSelected.cpp: CUndoItemShiftTabWhenSelected クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemShiftTabWhenSelected::CUndoItemShiftTabWhenSelected()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemShiftTabWhenSelected::Do()
{
}
	...
	)
{
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			...
			if( !IsDBCSLeadByteEx(0,ucBuf) && (ucBuf==VK_TAB) )
			{
	...
	if( (lSelectEndOffset != 0) && (bIsDelTab != FALSE) )
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemShiftTabWhenSelected::doUndo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemShiftTabWhenSelected::doRedo()
{
	unsigned char c1stChar=0;					// DELETEされた第一バイト文字
	unsigned char c2ndChar=0;					// DELETEされた第二バイト文字
	UCHAR	ucBuf;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemShiftTabWhenSelected::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemShiftTabWhenSelected::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemShiftTabWhenSelected::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemShiftTabWhenSelected::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
