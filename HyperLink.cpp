...
COLORREF CHyperLink::g_crHoverColor		= RGB(255, 0, 255);	// Red
...
/*[2]-----------------------------------------------------------------------------[2]*/
/*|	概要	：オブジェクトが既存のウインドウにアタッチされた後で呼び出される処理	|*/
/*|	解説	：																		|*/
/*|	備考	：																		|*/
/*|	履歴	：																		|*/
/*|	I/F		：																		|*/
...
void CHyperLink::AdjustWindow()
{
	...
	// upper-left corner of the parent window痴 client area. 
...
void CHyperLink::SetDefaultCursor()
{
	if(g_hLinkCursor == NULL)		// No cursor handle - load our own
		g_hLinkCursor = ((CEditorApp*)AfxGetApp())->LoadCursor(IDC_HAND);
}
...
void CHyperLink::ReportError(int nError)
{
	...
	str = "Can't open link:\n\n" + str;
	((CEditorApp*)AfxGetApp())->MyMessageBox(str, MB_ICONEXCLAMATION | MB_OK);
}
