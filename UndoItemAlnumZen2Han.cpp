// UndoItemAlnumZen2Han.cpp: CUndoItemAlnumZen2Han クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemAlnumZen2Han::CUndoItemAlnumZen2Han()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			...
			for(long nCnt=lSelectStartOffset; nCnt<lEndOffsetAfter; )
			{
				...
				pobjLine->InsertChar(nCnt,(cHanChar&0x00ff),0);
				nCnt++;
				//終了オフセットを更新
				lEndOffsetAfter--;
			}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemAlnumZen2Han::doUndo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemAlnumZen2Han::doRedo()
{
	UINT unChar=0;
	CCodeConvManager	objCodeConvManager;
	long lEndOffsetAfter = 0;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemAlnumZen2Han::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemAlnumZen2Han::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemAlnumZen2Han::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemAlnumZen2Han::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
