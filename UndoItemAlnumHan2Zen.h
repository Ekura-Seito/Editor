// UndoItemAlnumHan2Zen.h: CUndoItemAlnumHan2Zen クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemAlnumHan2Zen_H)		//２重インクルード防止
#define UndoItemAlnumHan2Zen_H
...
class CUndoItemAlnumHan2Zen : public CUndoItem
{
public:
	CUndoItemAlnumHan2Zen();								// コンストラクタ
	CUndoItemAlnumHan2Zen(CEditorDoc*);						// コンストラクタ
	virtual ~CUndoItemAlnumHan2Zen();						// デストラクタ
...
#endif // !defined(UndoItemAlnumHan2Zen_H)
