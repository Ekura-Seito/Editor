// UndoItemInsAsmComment.h: CUndoItemInsAsmComment クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////

#if !defined(UndoItemInsAsmComment_H)		//２重インクルード防止
...
{
public:
	CUndoItemInsAsmComment();								// コンストラクタ
	CUndoItemInsAsmComment(CEditorDoc*);					// コンストラクタ
	virtual ~CUndoItemInsAsmComment();						// デストラクタ
...
private:
	...
	//操作情報
	long		m_lStartLine;								// アセンブラコメント処理後の開始位置の行番号
	long		m_lStartOffset;								// アセンブラコメント処理後の開始位置の列番号
	long		m_lEndLine;									// アセンブラコメント処理後の終了位置の行番号
	long		m_lEndOffset;								// アセンブラコメント処理後の終了位置の列番号

	long		m_lSelectStartLine;							// 選択開始行番号（アセンブラコメント処理前）
	long		m_lSelectStartOffset;						// 選択開始列番号（アセンブラコメント処理前）
	long		m_lSelectEndLine;							// 選択終了行番号（アセンブラコメント処理前）
	long		m_lSelectEndOffset;							// 選択終了列番号（アセンブラコメント処理前）
