// UndoItemTabWhenSelected.cpp: CUndoItemTabWhenSelected クラスのインプリメンテーション
//
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
CUndoItemTabWhenSelected::CUndoItemTabWhenSelected()
{
	m_bIsCanUndo = TRUE;
	m_bIsCanRedo = TRUE;
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTabWhenSelected::Do()
{
}
	...
	)
{
	...
	if( lSelectStartLine == lSelectEndLine ) //１行選択
	{
		...
		if( pobjLine != NULL )
		{
			pobjLine->InsertChar(lSelectStartOffset,VK_TAB,0);
	...
	else //複数行選択
	{
		for(ULONG lCnt=0; lCnt<(ULONG)(lSelectEndLine-lSelectStartLine+1); lCnt++ )
		{
			...
			if( pobjLine != NULL )
			{
				...
				{
					//行頭にタブコード挿入
					pobjLine->InsertChar(0,VK_TAB,0);
				}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTabWhenSelected::doUndo()
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTabWhenSelected::doRedo()
{
	///////////////////////////////
	//	処理実行
	///////////////////////////////
	...
	if( m_lSelectStartLine == m_lSelectEndLine ) //１行選択
	{
		...
		{
			//タブコード挿入
			pobjLine->InsertChar(m_lSelectStartOffset,VK_TAB,0);
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemTabWhenSelected::IsCanUndo()
{
	return m_bIsCanUndo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
BOOL CUndoItemTabWhenSelected::IsCanRedo()
{
	return m_bIsCanRedo;
}
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTabWhenSelected::setCanUndo
	(	BOOL	bIsCanUndo
	)
{
...
/*|	I/F		：																		|*/
/*[0]-----------------------------------------------------------------------------[0]*/
void CUndoItemTabWhenSelected::setCanRedo
	(	BOOL	bIsCanRedo
	)
{
